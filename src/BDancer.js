var BDancer = function(top, left, timeBetweenSteps){
  ...
  this.$node.removeClass( "dancer" ).addClass( "BDancer");
...
BDancer.prototype = Object.create(makeDancer.prototype);
BDancer.prototype.constructor = BDancer;
BDancer.prototype.oldStep = BDancer.prototype.step;

BDancer.prototype.step = function(){
